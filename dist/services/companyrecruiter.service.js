...
export const GetCompanyRecruiterByIdService = async (id) => {
...
export const UpdateCompanyRecruiterByIdService = async (id, data) => {
...
export const DeleteCompanyRecruiterByIdService = async (id) => {
