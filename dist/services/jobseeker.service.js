...
export const getJobSeekerByIdService = async (id) => {
...
export const updateJobSeekerByIdService = async (jobseekerId, data) => {
...
export const deleteJobSeekerByIdService = async (jobseekerId) => {
...
export const getJobSeekerDashboardService = async (jobseekerId) => {
    const jobseeker = await prisma.jobSeeker.findUnique({
        where: { id: jobseekerId },
        select: {
            id: true,
